...
import { getColumns } from 'components/dashboard/organisation/role/tables/Define';
...
const RoleList = (props: any) => {
  ...
  const deleteRoleHandler = useCallback((id: any) => {
  ...
  return useMemo(() => 
    <ResponsiveTable 
      data={list || []} 
      columns={getColumns({t, deleteRoleHandler, location, lang, activedLanguage})} 
    />
  , [list, lang])
}
