import { 
  Box,
FormControl, FormLabel, InputGroup, Stack, 
...
const DurationInput = (props: any) => {
  ...
  return (
    <FormControl id='accessCodeDuration'>
      <Stack
        direction={{ base: 'column', md: 'row' }}
        spacing={{ base: '1.5', md: '8' }}
        justify="space-between"
      >
        <FormLabel m={0} minW={150}>{t('input.access-code-duration.label')}&nbsp;<span style={{color: 'red'}}>*</span></FormLabel>
        <Box w={'100%'}>
