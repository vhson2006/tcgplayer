...
import SearchProductForm from 'components/dashboard/business/product/forms/SearchForm';
import { actions } from 'components/dashboard/business/product/slice';
import { useEffect } from 'react';
import { useSelector, useDispatch } from 'react-redux';
import { usePath } from 'utils/link';
import ProductList from 'components/dashboard/business/product/tables/List';
import Pagination from 'modules/others/Pagination';

export const ProductPage = () => {
  const { total } = useSelector((state: any) => state.productReducer); 
