...
export const getLightModeBorderImage = (options = {}) => {
  const {
    borderTopWidth = 5,
    borderRightWidth = 5,
    borderBottomWidth = 5,
...
export const getDarkModeBorderImage = (options = {}) => {
  const {
    borderTopWidth = 5,
    borderRightWidth = 5,
    borderBottomWidth = 5,
...
export const getBorderLineStyles = (background = "bg-muted") => {
  return {
    position: "relative",
    bg: "unset",
    _before: {
...
export const getCircleBorderStyles = (size = "64", background = "inherit") => {
  return {
    position: "relative",
    borderRadius: "full",
    margin: "1px",
